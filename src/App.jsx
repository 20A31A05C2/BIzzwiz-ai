...
// import ProjectManagementPage from '@/components/views/ProjectManagementPage'; // Ensure this import is added
// import UserSettingsPage from '@/components/views/UserSettingsPage'; // Add this import
// //import PaymentPage from '@/components/views/PaymentPage'; // Existing or new component
// import ScheduleMeetPage from '@/components/views/ScheduleMeetPage'; // New component
...
//       <Route path="/dashboard-project/:projectId" element={<ProjectManagementPage />} /> {/* Updated to ProjectManagementPage */}
