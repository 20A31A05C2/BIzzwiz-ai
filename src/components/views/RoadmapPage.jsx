...
//         endpoint = `/roadmap/${selectedProject}`;
//       }
...
//         toast({
//           title: 'Erreur',
//           description: response.message || 'Échec du chargement des éléments de la roadmap.',
//           variant: 'destructive',
//         });
//       }
//     } catch (error) {
//       toast({
//         title: 'Erreur',
//         description: error.message || 'Une erreur est survenue lors de la récupération des éléments de la roadmap.',
//         variant: 'destructive',
//       });
//     } finally {
...
//     ? roadmapItems 
//     : roadmapItems.filter(item => item.project_id == selectedProject);

//   return (
//     <div className="p-6 max-w-6xl mx-auto">
//       <Card className="bg-bizzwiz-deep-space/30 border-bizzwiz-electric-cyan/20 shadow-lg">
//         <CardHeader className="border-b border-bizzwiz-electric-cyan/50">
//           <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
//             <CardTitle className="text-2xl font-bold text-bizzwiz-star-white flex items-center gap-2">
//               <ClipboardList className="h-6 w-6 text-bizzwiz-electric-cyan" />
//               Feuille de Route du Projet
//             </CardTitle>
//             <div className="flex items-center gap-2">
//               {userProjects.length > 0 && (
//                 <Select value={selectedProject} onValueChange={setSelectedProject}>
//                   <SelectTrigger className="w-[200px] bg-bizzwiz-deep-space/50 border-bizzwiz-electric-cyan/20 text-bizzwiz-star-white">
//                     <SelectValue placeholder="Sélectionner un projet" />
//                   </SelectTrigger>
//                   <SelectContent className="bg-bizzwiz-deep-space border-bizzwiz-electric-cyan/20">
//                     <SelectItem value="all" className="text-bizzwiz-star-white hover:bg-bizzwiz-electric-cyan/20">
//                       Tous les projets
//                     </SelectItem>
...
//                         className="text-bizzwiz-star-white hover:bg-bizzwiz-electric-cyan/20"
//                       >
...
//                 variant="outline"
//                 size="sm"
//                 className="border-bizzwiz-electric-cyan/20 text-bizzwiz-electric-cyan hover:bg-bizzwiz-electric-cyan/10"
//               >
...
//               <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-bizzwiz-electric-cyan mx-auto mb-4"></div>
...
//                     <div
//                       key={item.id}
//                       className="group p-4 border border-bizzwiz-electric-cyan/20 rounded-lg bg-bizzwiz-deep-space/50 hover:bg-bizzwiz-deep-space/70 transition-all duration-200"
//                     >
...
//                             </h3>
//                             {selectedProject === 'all' && item.project && (
//                               <p className="text-sm text-bizzwiz-electric-cyan/70 mb-1">
//                                 Projet: {item.project.project_name || item.project.name}
//                               </p>
//                             )}
//                             {item.description && (
...
//                         {item.target_date && (
//                           <div className="flex items-center gap-2">
//                             <CalendarDays className="h-4 w-4 text-bizzwiz-electric-cyan/70" />
//                             <span>
...
//                         {item.assigned_to && (
//                           <div className="flex items-center gap-2">
//                             <Users className="h-4 w-4 text-bizzwiz-electric-cyan/70" />
//                             <span>Assigné à: {item.assigned_to}</span>
//                           </div>
//                         )}
//                         <div className="flex items-center gap-2">
//                           <span className="text-bizzwiz-electric-cyan/70">Ordre: {item.order_index || 0}</span>
//                         </div>
//                       </div>
//                     </div>
//                   );
